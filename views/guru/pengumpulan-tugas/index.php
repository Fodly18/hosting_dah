		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<form action="/kelas_b/team_1/pengumpulan-tugas/filter" method="POST">
							...
							<?php foreach ($dataTugas as $row): ?>
								<tr>
									...
									<td class="action-buttons">
										<a href="/kelas_b/team_1/pengumpulan-tugas/show/<?= $row['id']; ?>" class="btn btn-success" id="btn-show-tugas">
