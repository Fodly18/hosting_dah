...
<body>
    ...
    <div class="head-title">
        ...
        <a href="/kelas_b/team_1/Acara_sekolah/create" class="btn btn-primary">
            ...
            <?php $no = 1; foreach ($data as $row): ?>
                <tr>
                    ...
                    <td class="action-buttons">
                        <a href="/kelas_b/team_1/Acara_sekolah/update/<?= urlencode($row['id']); ?>" class="btn btn-success btn-edit">
                            <i class='bx bx-edit-alt'></i>
                            <span>Edit</span>
                        </a>
						<a href="/kelas_b/team_1/Acara_sekolah/delete/<?= urlencode($row['id']); ?>" 
