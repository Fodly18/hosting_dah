...
<body>
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="/kelas_b/team_1/Berita">Gallery</a></li>
                        <li><i class='bx bx-chevron-right'></i></li>
    ...
    <form action="/kelas_b/team_1/Prestasi/create" method="post" id="createForm" onsubmit="return validateForm()" enctype="multipart/form-data">
