...
<main>
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="/kelas_b/team_1/Acara_sekolah">Gallery</a></li>
                <li><i class='bx bx-chevron-right'></i></li>
    ...
    <div class="form-container">
        ...
        <form action="/kelas_b/team_1/Prestasi/update" method="post" id="updateForm" onsubmit="return validateForm()" enctype="multipart/form-data">
    ...
    <div class="form-button">
        ...
        <a href="/kelas_b/team_1/Prestasi" class="btn btn-danger">
            <i class='bx bx-x'></i>
            <span>Batal</span>
        </a>
    </div>
