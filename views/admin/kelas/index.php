	...
	<section id="content">
        ...
        <main>
            <div class="head-title">
                ...
                <a href="/kelas_b/team_1/kelas/create" class="btn btn-primary">
                            ...
                            <?php $no = 1; foreach ($data as $row): ?>
                                <tr>
                                    ...
                                    <td class="action-buttons">
                                        <a href="/kelas_b/team_1/kelas/update/<?= $row['id']; ?>" class="btn btn-success">
                                            <i class='bx bx-edit-alt'></i>
                                            <span>Edit</span>
                                        </a>
                                        <a href="/kelas_b/team_1/kelas/delete/<?= $row['id']; ?>" 
