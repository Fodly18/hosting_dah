...
<head>
    ...
    <link rel="stylesheet" href="/kelas_b/team_1/assets/css/Berita.css">
...
<div id="loader">
  ...
  <i class="fas fa-chevron-down"></i>
    ...
    <!-- Banner  -->
    <div class="banner">
        <img class="banner-jpg" src="/kelas_b/team_1/assets/img/banner-berita.jpg" alt="Banner JPG">
    </div>
    ...
    <?php foreach ($currentNews as $index => $row): ?>
        <div class="news-item" id="berita-<?= htmlspecialchars($row['id']); ?>" 
            ...
            <div class="news-content">
                ...
                <a href="/kelas_b/team_1/blog/<?= urlencode($row['id']); ?>" class="read-more-btn">Baca Selengkapnya</a>
            </div>
        </div>
    <?php endforeach; ?>
</div>
